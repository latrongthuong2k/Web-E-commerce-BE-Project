...
import com.ecommerce.myapp.Users.Audit.ApplicationAuditAware;
...
public class AppConfiguration {
    ...
    // tìm nạp từ interface userdetail và băm pass
    @Bean
    ...
    public AuditorAware<Integer> auditorAware(AppUserRepository appUserRepository) {
        return new ApplicationAuditAware(appUserRepository);
    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000")); // Cho phép domain của FE
//        configuration.setAllowedOrigins(List.of("*")); // Cho phép domain của FE
