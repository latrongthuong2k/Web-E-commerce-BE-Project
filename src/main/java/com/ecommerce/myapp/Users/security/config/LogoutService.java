package com.ecommerce.myapp.Users.security.config;

import com.ecommerce.myapp.Users.security.Auth.AuthenticationControllerV2;
...
public class LogoutService implements LogoutHandler {
    ...
    public void logout(
      ...
      String cookieJwt = AuthenticationControllerV2.getCookieByName(request, "auth-token");
        ...
        cookie.setPath("/");
        cookie.setMaxAge(0); // Cookie sẽ hết hạn ngay lập tức
